...
, SDL2, pipewire, mesa, udev, pixman, libinput, libseat, xwayland, glslang

, stb, wlroots, libliftoff }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "gamescope";
    rev = "${version}";
    sha256 = "dlVoYQcqXJ0P+eX8rMGLGylMog1IodM6Y8BHg1hY70I=";
  };
  ...
  nativeBuildInputs = [ cmake meson pkg-config ninja ];
